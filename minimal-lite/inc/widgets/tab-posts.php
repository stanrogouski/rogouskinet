            ...
            <div class="tabbed-head">
                <ul class="nav nav-tabs primary-background" role="tablist">
                    <li role="presentation" class="nav-item tab tab-popular" >
                        <a href="" aria-controls="<?php esc_attr_e('Popular', 'minimal-lite'); ?>" role="tab" class="primary-bgcolor nav-link active" data-bs-toggle="tab" data-bs-target="#ms-popular" type="button" role="tab"  aria-selected="true" >
                            <span class="tab-icon">
                    ...
                    <li class="tab tab-recent nav-item">
                        <a href="" aria-controls="<?php esc_attr_e('Recent', 'minimal-lite'); ?>" role="tab" data-bs-toggle="tab" class="primary-bgcolor nav-link" data-bs-target="#ms-recent" type="button" role="tab"  aria-selected="true" >
                            <span class="tab-icon">
