...
if (!function_exists('minimal_lite_posted_date_only')) :
    ...
    function minimal_lite_posted_date_only()
    {
        ...
        $archive_month = get_the_time('m'); 
        $archive_day   = get_the_time('d'); 
        $posted_on = '<a href="' . esc_url(get_day_link( $archive_year, $archive_month, $archive_day)) . '" rel="bookmark">'. '<span class="thememattic-icon ion-android-alarm-clock"></span> ' . $time_string . '</a>';
