...
if (!function_exists('minimal_lite_inline_css')) :
    ...
    function minimal_lite_inline_css()
    {
        ...
        <style type="text/css">
			...
			.widget.widget_block button {background: <?php echo esc_html($minimal_lite_primary_color); ?> ;
            <?php
            }
			...
			.widget.widget_block button:focus,.widget.widget_block button:hover {background: <?php echo esc_html($minimal_lite_secondary_color); ?> ;
