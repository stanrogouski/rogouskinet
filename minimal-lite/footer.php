        ...
        <div class="site-copyright">
            <div class="container-fluid">
                ...
                if ($enable_footer_credit) {
                    printf(esc_html__('Theme: %1$s by %2$s', 'minimal-lite'), '<a href="https://www.thememattic.com/theme/minimal-lite/" target = "_blank" rel="designer">Minimal Lite</a>', '<a href="http://thememattic.com/" target = "_blank" rel="designer">Thememattic</a>');
                }
                ?>
            </div>
        </div>
